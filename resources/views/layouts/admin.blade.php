        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link bg-info rounded dropdown-toggle" href="#" id="navbarVersionDropdown"
                    ...
                    <div class="dropdown-menu py-0" aria-labelledby="navbarVersionDropdown">
                        ...
                        <a class="dropdown-item" href="https://adminlte.io/themes/AdminLTE/documentation/index.html">
                            <= v2.3</a> </div> </li> </ul> <ul class="navbar-nav ml-auto">
      ...
      <div class="input-group input-group-sm">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="index.html" class="brand-link logo-switch">
                ...
                <img src="assets/img/logo-xl.png" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl"
                    style="left: 12px">
            </a>
            <div class="sidebar">
                <nav class="mt-2">
        ...
        <div class="content-wrapper px-4 py-2">
            ...
            <div class="content px-2">
                <p>AdminLTE can be installed using multiple methods. Pick your favorite method from the list below.
                    Please be sure to check the dependencies section before continuing.</p>

                <h4>Download</h4>

                <h6><strong>From Github</strong></h6>
                <p>Visit the releases section on Github and download the <a
                        href="https://github.com/ColorlibHQ/AdminLTE/releases">latest release</a>.</p>

                <h4>Command Line</h4>

                <h6><strong>Via NPM</strong></h6>
                <div class="language-bash highlighter-rouge">
                    <div class="highlight">
                        <pre class="highlight"><code>npm <span class="nb">install </span>admin-lte@^3.0 <span class="nt">--save</span>
</code></pre>
                    </div>
                </div>

                <h6><strong>Via Yarn</strong></h6>
                <div class="language-bash highlighter-rouge">
                    <div class="highlight">
                        <pre class="highlight"><code>yarn add admin-lte@^3.0
</code></pre>
                    </div>
                </div>

                <h6><strong>Via Composer</strong></h6>
                <div class="language-bash highlighter-rouge">
                    <div class="highlight">
                        <pre class="highlight"><code>composer require <span class="s2">"almasaeed2010/adminlte=~3.0"</span>
</code></pre>
                    </div>
                </div>

                <h6><strong>Via Git</strong></h6>
                <div class="language-bash highlighter-rouge">
                    <div class="highlight">
                        <pre class="highlight"><code>git clone https://github.com/ColorlibHQ/AdminLTE.git
</code></pre>
                    </div>
                </div>
